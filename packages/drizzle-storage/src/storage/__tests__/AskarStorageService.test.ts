...
import { AskarModuleConfig } from '../../DrizzleStorageModuleConfig'
import { PostgresPoolManager } from '../../AskarStoreManager'
import { AskarStorageService } from '../DrizzleStorageService'
...
describe('AskarStorageService', () => {
  ...
  let storeManager: PostgresPoolManager
  ...
  beforeEach(async () => {
    ...
    storeManager = new PostgresPoolManager(
      new NodeFileSystem(),
