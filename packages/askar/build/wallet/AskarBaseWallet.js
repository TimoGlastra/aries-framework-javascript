...
class AskarBaseWallet {
    ...
    async directEncryptCompactJweEcdhEs({ recipientKey, encryptionAlgorithm, apu, apv, data, header, }) {
        ...
        const encodedHeader = core_1.JsonEncoder.toBuffer(_header);
        const ecdh = new aries_askar_shared_1.EcdhEs({
            algId: Uint8Array.from(core_1.Buffer.from(encAlg)),
        ...
        const compactJwe = `${core_1.TypedArrayEncoder.toBase64URL(encodedHeader)}..${core_1.TypedArrayEncoder.toBase64URL(nonce)}.${core_1.TypedArrayEncoder.toBase64URL(ciphertext)}.${core_1.TypedArrayEncoder.toBase64URL(tag)}`;
        return compactJwe;
    }
    /**
    ...
    async directDecryptCompactJweEcdhEs({ compactJwe, recipientKey, }) {
        ...
        const plaintext = ecdh.decryptDirect({
            ...
            aad: core_1.TypedArrayEncoder.fromBase64(encodedHeader),
        });
