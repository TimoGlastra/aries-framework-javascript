...
export class ConnectionService {
  ...
  public async findByTheirDid(agentContext: AgentContext, did: string): Promise<ConnectionRecord | null> {
    return this.connectionRepository.findSingleByQuery(agentContext, { theirDid: did })
  }

  public async findByOurDid(agentContext: AgentContext, did: string): Promise<ConnectionRecord | null> {
    return this.connectionRepository.findSingleByQuery(agentContext, { did })
  }
