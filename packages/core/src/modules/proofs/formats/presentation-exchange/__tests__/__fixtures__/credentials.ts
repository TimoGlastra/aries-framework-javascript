...
export const transmuteUniversityCredential1 = {
...
} satisfies IVerifiableCredential

export const transmuteUniversityCredential2 = {
  '@context': ['https://www.w3.org/2018/credentials/v1', 'https://www.w3.org/2018/credentials/examples/v1'],
  id: 'http://example.gov/credentials/39392',
  type: ['VerifiableCredential', 'UniversityDegreeCredential'],
  issuer: 'did:web:vc.transmute.world',
  issuanceDate: '2020-03-16T22:37:26.544Z',
  credentialSubject: {
...
export const animoUniversityCredential1 = {
...
export const animoUniversityCredential2 = {
  '@context': ['https://www.w3.org/2018/credentials/v1', 'https://www.w3.org/2018/credentials/examples/v1'],
