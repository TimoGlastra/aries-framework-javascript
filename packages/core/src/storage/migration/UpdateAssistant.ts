...
export class UpdateAssistant {
  ...
  public constructor(agent: Agent, updateConfig: UpdateConfig) {
    ...
    this.agentContext = this.agent.injectionContainer.resolve<AgentContext>(InjectionSymbols.AgentContext)
    this.fileSystem = this.agent.injectionContainer.resolve<FileSystem>(InjectionSymbols.FileSystem)
  }
