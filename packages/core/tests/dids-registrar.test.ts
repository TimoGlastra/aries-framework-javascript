import type { SovDidCreateOptions } from '../src/modules/dids/methods/indy/IndyDidRegistrar'
...
describe('dids', () => {
  ...
  it('should create a did:sov did', async () => {
    // agentDependencies.indy.createAndStoreMyDid(wh, {
    ...
    console.log(await agent.dids.resolve(did.didState.did))
  })
})
